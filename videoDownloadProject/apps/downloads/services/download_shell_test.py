from apps.downloads.services.playlist import enqueue_playlist_downloads
...
# video_url = "https://www.youtube.com/watch?v=if99Olw78WE&list=PLeXyx0kOyiXu_ju_10w9qDzqSDXYpqXD" # playlist
...
# Run Fetch + Download
enqueue_playlist_downloads(user, video_url)